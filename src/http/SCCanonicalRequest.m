...
//
//  Derived from SPDYCanonicalRequest.m from https://github.com/twitter/CocoaSPDY
    ...
    // Canonicalise the request headers.
{
    ...
    // NSURLRequest will automatical/Users/alex/Workspace/seacat/client-ios-new/src/http/SPDYCanonicalRequest.mly set the content-length header when HTTPBody is used,
...
extern NSMutableURLRequest *SCCanonicalRequestForRequest(NSURLRequest *request)
{
